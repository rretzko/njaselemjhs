...
--}} -->
                <form class="space-y-8 divide-y divide-gray-200" method="post"
                    ...
                    <div class="space-y-8 divide-y divide-gray-200">
                        ...
                        <div class="pt-1">
                            <div id="labels" class="flex row mt-2 ">
                                <div style="width: 30%;">
                            ...
                            <div class="sm:col-span-3">
                                ...
                                <div class="mt-1">
                                    <select id="country" name="country" autocomplete="country"
                                            class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md @error('country') border border-gray-300 @enderror">
                                        <option>US</option>
                                        <option>CA</option>
                                        <option>MX</option>
                                    </select>
                        ...
                        <fieldset class="mt-6">
                            ...
                            <div class="sm:col-span-2 mt-1">
                                ...
                                <div class="mt-1">
                                    <a href="{{ $director->membership_card }}" title="Click for membership card"
                                       target="_blank" style="color: rgb(97,0,174);">
