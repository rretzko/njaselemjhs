                        ...
                        <div class="py-2 align-middle inline-block min-w-full sm:px-6 lg:px-8">
                            <div class="shadow overflow-hidden border-b border-gray-200 sm:rounded-lg">
                                ...
                                <div class="mb-3 text-right mr-3">
                                    <a href="{{ route('administration.download.directors') }}" style="background-color: rgba(0,255,0,0.5); color: darkgreen; border-radius: 0.5rem;" class="bg-green-500 text-white rounded px-2 text-sm ">
                                        Download
                                    </a>
                                </div>
